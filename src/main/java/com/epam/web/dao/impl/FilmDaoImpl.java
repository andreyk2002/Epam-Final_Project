...
public class FilmDaoImpl extends AbstractDao<Film> implements FilmDao {
    ...
    private static final String FIND_BY_GENRE_ID = "SELECT * FROM films f JOIN filmsgenres fg ON f.ID = fg.FilmID  WHERE fg.GenreID = ?";
    ...
    @Override
    public List<Film> getFilmsByName(String searchString) throws DaoException {
        return executeQuery(FIND_BY_NAME, searchString);
    }

    @Override
    public List<Film> getByGenreId(long genreId) throws DaoException {
